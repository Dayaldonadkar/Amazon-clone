...
const Header = () => {
  return (
    <div className="flex lg:flex-row md:flex-col sm:flex-col flex-col sm:justify-around  sm:items-center bg-[#131921] text-white py-4 gap-y-5 px-5 lg:px-40">
      <img
      ...
      <div className="flex align-center rounded-3xl h-8">
        <input
          className="border-none sm:px-56 md:20 lg:w-[700px]  w-full"
          type="text"
        />
